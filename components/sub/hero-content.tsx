    ...
    >
      ...
      <div className="w-full flex flex-col gap-5 justify-center m-auto text-center md:text-start">
        ...
        <motion.p
          ...
          className="text-base sm:text-lg text-gray-400 my-3 sm:my-4 max-w-[500px] mx-auto md:mx-0 font-semibold"
        >
          Reliability by Design, Velocity by Habit.
        </motion.p>
